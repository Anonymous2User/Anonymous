...
% 颜值即正义1
c_string{2} = {'#000000','#FD6D5A', '#FEB40B', '#6DC354', '#994487', '#518CD8', '#E74745', '#EFB9C1', '#FBCD60', '#FEFB66', '#1AC0C6', '#FB7857','#C8A9A1','#BCBD22'};
% 颜值即正义2
c_string{3} = {'#000000','#FD6D5A', '#FEB40B', '#6DC354', '#994487', '#518CD8','#264653', '#2A9D8F', '#E9C46A', '#F4A261', '#E76F51', '#253777', '#3BB9C1', '#F86B0D', '#FAA900'};
% 颜值即正义3
c_string{1} = {'#1F77B4', '#FF7F0E', '#2CA02C', '#D62728', '#9467BD', '#8C564B','#E377C2','#7F7F7F','#BCBD22','#17BECF','#FF9896','#000000','#98DF8A', '#B913FF'};
% 颜值即正义4
